...
1. ARIMAX Model for Home Value ~ Sale Price + Rental Price
...
2. ARIMAX Model for Saving Rate ~ Household Income + Household Saving
...
3. VAR Model for Sale Price, Saving Rate, GDP Deflator
...
4. ARIMAX Model for GINI Index (Household Income + Household Saving + Sale Price)
...
5. VAR Model for Home Value (Saving Rate + GDP Deflator + Sale Price)
