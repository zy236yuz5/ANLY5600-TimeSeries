...
df$MA2 <- SMA(df$MSPUS, n=2)
df$MA8 <- SMA(df$MSPUS, n=8)
df$MA16 <- SMA(df$MSPUS, n=16)
...
fig <- df %>%
  ...
  add_lines(x = ~DATE, y = ~MSPUS, name = 'Original', line = list(color = 'blue')) %>%
  add_lines(x = ~DATE, y = ~MA2, name = 'MA(2)', line = list(color = 'red', dash = 'dash')) %>%
  add_lines(x = ~DATE, y = ~MA8, name = 'MA(8)', line = list(color = 'green', dash = 'dash')) %>%
  add_lines(x = ~DATE, y = ~MA16, name = 'MA(16)', line = list(color = 'purple', dash = 'dash')) %>%
